...
![Path in Linux](images/chapter1path-linux_9be164a3.webp)
...
![Absolute path vs relative path](images/chapter1relative-path-cd_1bd59bec.png)
...
![Most Linux terminal prompts show the current location](images/chapter1linux-terminal-prompt_aed47ed9.png)
...
![cd command example](images/chapter1cd-command-example_241506f3.svg)
...
![Common examples of "no such file or directory" error](images/chapter1common-errors-with-cd_68ccf793.png)
...
![Not a directory error with the cd command](images/chapter1not-a-directory-error-linux_6c1108ad.png)
...
![Too many arguments error in Linux terminal](images/chapter1too-many-arguments_abc3f65e.png)
