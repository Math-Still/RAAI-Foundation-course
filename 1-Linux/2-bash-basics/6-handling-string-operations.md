...
![Example of getting string length in bash](images/bash-string-length-example_cc52bf3d.png)
...
![Join two strings in bash](images/join-strings-bash_7caa49e2.png)
...
![Extracting substring in bash](images/extract-substring-bash_535fb424.png)
...
![Replace substring in bash](images/replace-substring-bash_86244ac6.png)
...
![Delete substring in bash](images/bash-delete-substring_f3becdee.png)
