...
![Pass arguments to the bash scripting](images/run-bash-script-with-arguments_5f1c78c9.png)
...
![Passing fewer or more arguments to bash script](images/passing-non-matching-arguments-bash-shell_4e6ce1d3.png)
...
![Interactive bash shell script](images/interactive-bash-shell-script_c220f6e4.png)
