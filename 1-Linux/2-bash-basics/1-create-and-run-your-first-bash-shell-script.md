...
![Creating first shell script](images/bashbashchapter1create-first-shell-script_87d6188e.png)
...
![Run first shell script](images/bashbashchapter1run-first-shell-script_2c589ebc.png)
...
![Run shell scripts](images/bashchapter1running-shell-scripts_35519965.png)
...
![Run bash shell script](images/bashchapter1run-bash-shell-script_94d55cd5.png)
