...
![Running a script with if statement example in bash](images/bash-if-example_84fd2dd8.png)
...
![Running a bash script that checks odd even number](images/bash-if-else-example_d5e047c3.png)
...
![Running a script with bash elif statement](images/bash-elif_7ed037a1.png)
...
![Example of running  bash script with logical operators in if statement](images/bash-logical-operators-in-if-else_7bd7a6f4.png)
