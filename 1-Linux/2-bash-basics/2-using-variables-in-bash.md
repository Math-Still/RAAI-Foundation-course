...
![Using variables in shell](images/bashUsing-variables-in-shell_31896de9.png)

在 Bash shell 中，变量可以是数字、字符或字符串（包括空格在内的字符）。

![Different variable types in Bash shell](images/bash-variables-types_b67fedcd.png)
...
![Using global variable in Bahs script](images/using-global-variable-bash-script_c29cbdde.png)
...
![Using spaces in variable names in bash](images/using-spaces-in-bash-variable_d32d776d.png)
...
![Command substitution in bash](images/command-substitue-bash-variable_3ecd3d70.png)
